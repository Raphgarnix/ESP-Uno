...
<body>
    ...
    <div class="game-Container" id="gameContainer">
        ...
        <div class="readyup-Window" id="readyupWindow">
            ...
            <div class="readyup-Line"></div> <!-- Die vertikale Linie -->
    ...
    <button id="topRightButton" class="top-right-btn" title="Reset / Menu" onclick="ChangeResetAll()">
    ⟳
    </button>
    ...
    function handleMessage(event) {
        ...
        switch(data.type) {
            ...
            case "YourT":
                ...
                updateturnIndicator();
                updateHandPanel();
                updatePlayersHandPanels(); // 🔥 Highlight sofort aktualisieren
                break;
            ...
            case "reset":
                ...
                changeWindow("login");
                    ...
                    connectWebSocket(); // 🔥 open new socket
    ...
    function updatereadyupPlayers() {
        ...
        players.forEach((player, index) => {
            ...
            playerEl.textContent =
                `Player ${index}: ${player} ${ready ? "✅ Ready" : "❌ Not Ready"}`;
    ...
    function updatePlayersHandPanels() {
        ...
        players.forEach((player, index) => {
            ...
            if (lastcardPlayed[index] === '+') {
                lastCardDiv.textContent = lastcardPlayed[index] + lastcardPlayed[index + 1] || "—";
            } 
            else
